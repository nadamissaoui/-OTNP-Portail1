package tn.esprit.crmmodule.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // On remplace antMatchers par requestMatchers (Obligatoire en v6+)
                        .requestMatchers(
                                "/swagger-ui/**",
                                "/v3/api-docs/**",
                                "/swagger-resources/**",
                ...
                // On utilise Customizer.withDefaults() pour éviter le message "deprecated"
